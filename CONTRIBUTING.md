...
Please read these guidelines before contributing to meziantou/DepsUpdater:
...
If you have questions about how to use meziantou/DepsUpdater, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/DepsUpdater's existing code formatting and naming standard
- Run meziantou/DepsUpdater's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/DepsUpdater you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
